    ...
    return (
        <div className={s.home}>
            ...
            <div className={s.info_container}>
                ...
                <p>Вашему вниманию предлагаются эксклюзивные 3D Светильники от Российского производителя.Только у нас Вы
                ...
                <p> Наш интернет-магазин специализируется на разработке,производстве и продаже самых разных моделей 3D
                ...
                <p> Магазин <span className={s.name}>3Д-СВЕТИЛЬНИКИ.РФ</span> осуществляет доставку по всей территории
                    России а так же
                    странам СНГ любым
